...
public class HardGame extends AppCompatActivity implements View.OnClickListener{
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        switch (item.getItemId()){
            case R.id.home:
                startActivity(new Intent(HardGame.this, Home.class));
                return true;
            case R.id.settings:
                startActivity(new Intent(HardGame.this, Settings.class));
                return true;
            case R.id.scores:
                startActivity(new Intent(HardGame.this, Scores.class));
                return true;
            default:
